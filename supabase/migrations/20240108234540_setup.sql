...
AS $$
DECLARE
  project_url TEXT := 'https://jfworhwelouthzxwjgpv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impmd29yaHdlbG91dGh6eHdqZ3B2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNjg0Mjg2MiwiZXhwIjoyMDQyNDE4ODYyfQ.2vokTtNHn-wBCwo4FGP2aQvrDfVisZaP4au2PiYdL30'; -- full access needed for http request to storage
